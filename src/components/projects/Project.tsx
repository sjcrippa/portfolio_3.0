...
export default function Project({ title, description, tags, imageUrl, siteUrl }: ProjectProps) {
  ...
  return (
    ...
    >
      <section className='relative bg-gray-100 flex flex-col max-w-sm sm:max-w-[42rem] xl:max-w-[50rem] border border-black/5 overflow-hidden rounded-lg sm:pr-8 sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 group-hover:border-none'>
        <div className='pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col justify-center h-full sm:group-even:ml-[18rem] text-center md:text-left'>
        ...
        <Link href={siteUrl} target="_blank">
          <Image
            ...
            quality={95}
            className='sm:absolute sm:top-8 sm:-right-40 w-[28.25rem] rounded-t-lg shadow-2xl transition h-full object-cover
